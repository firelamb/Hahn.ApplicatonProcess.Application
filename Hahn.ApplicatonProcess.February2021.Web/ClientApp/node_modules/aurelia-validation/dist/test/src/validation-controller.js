define(["require", "exports", "./config", "./validator", "./property-info", "./validate-result", "./property-accessor-parser", "./validate-event"], function (require, exports, config_1, validator_1, property_info_1, validate_result_1, property_accessor_parser_1, validate_event_1) {
    "use strict";
    ...
    var ValidationController = /** @class */ (function () {
        function ValidationController(validator, propertyParser, config) {
            ...
            this.eventCallbacks = [];
            this.validateTrigger = config instanceof config_1.GlobalValidationConfiguration
                ? config.getDefaultValidationTrigger()
                : config_1.GlobalValidationConfiguration.DEFAULT_VALIDATION_TRIGGER;
        }
        /**
        ...
        ValidationController.inject = [validator_1.Validator, property_accessor_parser_1.PropertyAccessorParser, config_1.GlobalValidationConfiguration];
