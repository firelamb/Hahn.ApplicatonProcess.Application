define(["require", "exports", "tslib", "aurelia-binding", "aurelia-dependency-injection", "aurelia-templating", "./validation-controller", "aurelia-pal"], function (require, exports, tslib_1, aurelia_binding_1, aurelia_dependency_injection_1, aurelia_templating_1, validation_controller_1, aurelia_pal_1) {
    "use strict";
    ...
    var ValidationErrorsCustomAttribute = /** @class */ (function () {
        ...
        ValidationErrorsCustomAttribute.inject = function () {
            return [aurelia_pal_1.DOM.Element, aurelia_dependency_injection_1.Lazy.of(validation_controller_1.ValidationController)];
        };
