define(["require", "exports", "tslib", "./rules", "./validation-messages", "../util"], function (require, exports, tslib_1, rules_1, validation_messages_1, util_1) {
    "use strict";
    ...
    var FluentRuleCustomizer = /** @class */ (function () {
        ...
        FluentRuleCustomizer.prototype.satisfiesRule = function (name) {
            ...
            return (_a = this.fluentRules).satisfiesRule.apply(_a, tslib_1.__spreadArrays([name], args));
        };
        /**
        ...
        FluentRules.prototype.satisfiesRule = function (name) {
            ...
            if (!rule) {
                ...
                if (rule instanceof Function) {
                    return rule.call.apply(rule, tslib_1.__spreadArrays([this], args));
                }
            ...
            return this.satisfies(function (value, obj) {
                var _a;
                return (_a = rule.condition).call.apply(_a, tslib_1.__spreadArrays([_this, value, obj], args));
            }, config)
                .withMessageKey(name);
        };
        /**
