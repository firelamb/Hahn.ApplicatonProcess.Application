...
<html lang="en">
<head>
    <title>Code coverage report for src/rt/rt-binding-behavior.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/rt</a> rt-binding-behavior.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
  public bind(binding: any, source: any) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (sourceExpression.rewritten) {
