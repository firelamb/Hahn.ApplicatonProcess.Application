...
<html lang="en">
<head>
    <title>Code coverage report for src/relativeTime.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> relativeTime.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">5x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { EventAggregator } from "aurelia-event-aggregator";
&nbsp;
import {
  I18N,
  I18NEventPayload,
...
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (Array.isArray(alternateFb) &amp;&amp; alternateFb.length &gt; 0) {
...
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (trans[baseLocale]) {
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (trans[fallbackLng]) {
<span class="cstat-no" title="statement not covered" >      this.addTranslationResource(key, trans[fallbackLng].translation);</span>
    }
  }
&nbsp;
...
&nbsp;
    this.service.i18next.addResources(key, options.defaultNS || <span class="branch-1 cbranch-no" title="branch not covered" >"translation",</span> translation);
  }
&nbsp;
...
&nbsp;
    ...
    if (!timeDiff) {
      ...
      if (!timeDiff) {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!timeDiff) {
