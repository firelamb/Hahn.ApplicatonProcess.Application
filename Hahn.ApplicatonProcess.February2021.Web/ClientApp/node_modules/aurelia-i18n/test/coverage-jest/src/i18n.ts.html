...
<html lang="en">
<head>
    <title>Code coverage report for src/i18n.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> i18n.ts
    </h1>
    <div class='clearfix'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>131/139</span>
      </div>
    </div>
    <p class="quiet">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">14x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import i18next from "i18next";
import {
  DOM,
  PLATFORM
} from "aurelia-pal";
...
&nbsp;
    this.i18nextDeferred = new Promise((resolve, reject) =&gt; {
      this.i18next.init(options || defaultOptions, (err) =&gt; {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (err &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >!Array.isArray(err))</span> {
...
&nbsp;
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.i18next.options.attributes instanceof String) {
<span class="cstat-no" title="statement not covered" >          this.i18next.options.attributes = [this.i18next.options.attributes as any as string];</span>
        }
&nbsp;
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (pname &amp;&amp; node.au &amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >node.au[pname])</span> {
<span class="cstat-no" title="statement not covered" >          params = node.au[pname].viewModel.value;</span>
        }
&nbsp;
        if (keys) { break; }
      }
      // skip if nothing was found
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!keys) { <span class="cstat-no" title="statement not covered" >continue; </span>}
&nbsp;
...
&nbsp;
      ...
      while ((m = re.exec(key)) !== null) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (m.index === re.lastIndex) {
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (reservedNames.indexOf(attr) &gt; -1 &amp;&amp;
          node.au &amp;&amp;
          node.au.controller &amp;&amp;
<span class="branch-3 cbranch-no" title="branch not covered" >          node.au.controller.viewModel </span>&amp;&amp;
<span class="branch-4 cbranch-no" title="branch not covered" >          attrCC in node.au.controller.viewModel)</span> {
<span class="cstat-no" title="statement not covered" >          i18nLogger.warn(`Aurelia I18N reserved attribute name\n</span>
  [${reservedNames.join(", ")}]\n
...
&nbsp;
            for (let pi = prependParser.childNodes.length - 1; pi &gt;= 0; pi--) {
              ...
              <span class="missing-if-branch" title="else path not taken" >E</span>if (node.firstChild) {
                node.insertBefore(prependParser.childNodes[pi], node.firstChild);
              } else {
<span class="cstat-no" title="statement not covered" >                node.appendChild(prependParser.childNodes[pi]);</span>
              }
            }
            break;
          case "append":
...
&nbsp;
          ...
          default: // normal html attribute
            <span class="missing-if-branch" title="if path not taken" >I</span>if (node.au &amp;&amp;
<span class="branch-1 cbranch-no" title="branch not covered" >              node.au.controller </span>&amp;&amp;
<span class="branch-2 cbranch-no" title="branch not covered" >              node.au.controller.viewModel </span>&amp;&amp;
<span class="branch-3 cbranch-no" title="branch not covered" >              attrCC in node.au.controller.viewModel)</span> {
<span class="cstat-no" title="statement not covered" >              node.au.controller.viewModel[attrCC] = this.tr(key, params);</span>
            } else {
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Sat Sep 19 2020 14:16:08 GMT-0400 (Eastern Daylight Time)
</div>
</div>
